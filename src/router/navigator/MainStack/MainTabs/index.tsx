...
const MainTabs = () => {
  ...
  const isBigTablet = screenWidth >= deviceDimensions.bigTablet;
  if (isBigTablet) return null;

  const isPhone = screenWidth < deviceDimensions.smallTablet;
  // render BottomTab for phone, SideTab for small tablet
