...
export default class EmojiPicker extends PureComponent {
  constructor(props) {
    ...
    const emojis = this.renderableEmojis(props.emojisBySection, dimension.deviceWidth);
  ...
  getNumberOfColumns = (deviceWidth) => {
    const shorten = dimension.isPhoneWithInsets && this.props.isLandscape ? 4 : 2;
    return Math.floor(
      Number((
  ...
  renderEmptyList = () => <NoSearchResult />;
}
