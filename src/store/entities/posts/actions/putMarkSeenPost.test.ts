...
describe('putMarkSeenPost', () => {
  ...
  it('should put Mark Seen Post success:', () => {
    ...
    const spy = jest.spyOn(streamApi, 'putMarkSeenContent').mockImplementation(() => Promise.resolve(response) as any);
  ...
  it('should put Mark Seen Post throw error:', () => {
    ...
    const spy = jest.spyOn(streamApi, 'putMarkSeenContent').mockImplementation(() => Promise.reject(error) as any);
