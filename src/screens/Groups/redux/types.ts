const groupsTypes = {
  ...
  GET_PENDING_MEMBER_REQUESTS: 'groups/GET_PENDING_MEMBER_REQUESTS',
  SET_PENDING_MEMBER_REQUESTS: 'groups/SET_PENDING_MEMBER_REQUESTS',
  REMOVE_PENDING_REQUEST: 'groups/REMOVE_PENDING_REQUEST',
  CLEAR_ALL_PENDING_REQUESTS: 'groups/CLEAR_ALL_PENDING_REQUESTS',
};
