...
const GroupDetail = (props:any) => {
    ...
    console.log('\x1b[36m','namanh ---  | GroupDetail params: ', params,'\x1b[0m')
    console.log('\x1b[36m','namanh ---  | GroupDetail groupDetail : ', groupDetail,'\x1b[0m')
    ...
    const renderInfo = () => {
        return (
            <View style={styles.infoContainer}>
                ...
                <View style={{ flexDirection: 'row', alignItems: 'center', paddingHorizontal: spacing.padding.base, paddingTop: spacing.padding.small }}>
                    <Icon style={styles.iconSmall} icon={'iconPrivate'} size={14}/>
    ...
    return (
        <ScreenWrapper isFullView style={styles.container}>
            <Image style={styles.cover} source={cover ? {uri: cover} : images.img_cover_default}/>
            {renderInfo()}
