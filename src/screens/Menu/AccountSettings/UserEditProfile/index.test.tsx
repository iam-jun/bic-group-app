...
describe('UserEditProfile screen', () => {
  ...
  // it(`should hide avatar, cover image, description,
  // add work exp button and edit button in each item if is not current user`, async () => {
  ...
  // it(`should show avatar, cover image, description,
  // add work exp button and edit button in each item if is current user`, async () => {
