...
import GroupJoined from '~/screens/groups/YourGroups/components/GroupJoined';
import { useRootNavigation } from '~/hooks/navigation';
import modalActions, { showHideToastMessage } from '~/storeRedux/modal/actions';
import YourGroupsSearch from '~/screens/groups/YourGroups/components/YourGroupsSearch';
...
const YourGroups: FC<YourGroupsProps> = ({ route }: YourGroupsProps) => {
  ...
  if (!communityId) {
    ...
    dispatch(showHideToastMessage({ content: 'common:text_error_message', props: { isError: true } }));
  }
