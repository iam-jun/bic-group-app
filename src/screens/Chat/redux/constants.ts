...
export const GET_ROOM_MEMBERS = 'chat/GET_ROOM_MEMBERS';
export const SET_ROOM_MEMBERS = 'chat/SET_ROOM_MEMBERS';
export const SET_EXTRA_ROOM_MEMBERS = 'chat/SET_EXTRA_ROOM_MEMBERS';
export const MERGE_EXTRA_ROOM_MEMBERS = 'chat/MERGE_EXTRA_ROOM_MEMBERS';
