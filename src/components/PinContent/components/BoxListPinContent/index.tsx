...
const fake_data = [
  ...
  // },
  {
    id: 'daa5e2f4-d808-460c-bf0a-f14882499d56123',
    actor: {
      avatar: 'https://bic-dev-entity-attribute-s3-bucket.s3.ap-southeast-1.amazonaws.com/user/avatar/images/original/59f52ee1-5dd5-4284-b1b5-21b038fbbf78.jpg',
      email: 'namanh@tgm.vn',
      fullname: 'Nam Anh',
    ...
    createdAt: '2023-04-03T04:23:25.345Z',
    content: 'hello zxin chao post nay chi co text'
  },
  {
    id: 'daa5e2f4-d808-460c-bf0a-f14882499d56',
    actor: {
    ...
    createdAt: '2023-04-03T04:23:25.345Z',
    content: '**Dự án cầu Nguyễn Thái Học bắc qua rạch Long Xuyên**, gồm cầu chính dài *120 m*, rộng 16 m dành cho ôtô, xe máy và cầu dành cho người đi bộ bên cạnh, rộng 5,7-9,5 m. Toàn dự án tổng vốn đầu tư 200 tỷ đồng, khởi công tháng 5/2019 và khánh thành sau hai năm triển khai. Qua nửa năm vận hành, phần cầu cho người đi bộ bị phản ánh chất lượng chưa đảm bảo, sai thiết kế và phải "dặm vá"',
  },
   {
    id: 'daa5e2f4-d808-460c-bf0a-f14882499d563212',
    actor: {
      avatar: 'https://bic-dev-entity-attribute-s3-bucket.s3.ap-southeast-1.amazonaws.com/user/avatar/images/original/59f52ee1-5dd5-4284-b1b5-21b038fbbf78.jpg',
      email: 'namanh@tgm.vn',
      fullname: 'Nam Anh',
