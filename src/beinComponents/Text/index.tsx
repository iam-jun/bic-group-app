...
export interface BeinTextProps extends TextProps {
  variant?: 'h1' | 'h2' | 'h3' | 'h4' | 'h5' | 'h6' | 'bodyM' | 'body' | 'bodySM' | 'bodyS' | 'subtitle' | undefined,
...
const BodyM = ({...props}: BeinTextProps) => <Text variant={'bodyM'} {...props} />;
const Body = ({...props}: BeinTextProps) => <Text variant={'body'} {...props} />;
const BodySM = ({...props}: BeinTextProps) => <Text variant={'bodySM'} {...props} />;
const BodyS = ({...props}: BeinTextProps) => <Text variant={'bodyS'} {...props} />;
const Subtitle = ({...props}: BeinTextProps) => <Text variant={'subtitle'} {...props} />;
