...
!(function (e, t) {
  ...
  return function (t, n) {
    var r = (function (e) {
      ...
      var c = RegExp(r),
        s = RegExp(r, 'g');
      return {defs: n, shortcuts: t, scanRE: c, replaceRE: s};
    })(t.utils.assign({}, {defs: {}, shortcuts: {}, enabled: []}, n || {}));
    (t.renderer.rules.emoji = e),
      t.core.ruler.push(
        'emoji',
        (function (e, t, n, r, o) {
          var c = e.utils.arrayReplaceAt,
            s = e.utils.lib.ucmicro,
            u = new RegExp([s.Z.source, s.P.source, s.Cc.source].join('|'));
          function i(e, r, c) {
            var s,
              i = 0,
              l = [];
            return (
              e.replace(o, function (r, o, f) {
                var a;
                if (n.hasOwnProperty(r)) {
                  if (((a = n[r]), o > 0 && !u.test(f[o - 1]))) return;
                  if (o + r.length < f.length && !u.test(f[o + r.length]))
                    return;
                } else a = r.slice(1, -1);
                o > i &&
            ...
            for (n = 0, o = l.length; n < o; n++)
              if ('inline' === l[n].type)
                for (t = (s = l[n].children).length - 1; t >= 0; t--)
                  ('link_open' !== (u = s[t]).type &&
                    'link_close' !== u.type) ||
                    ('auto' === u.info && (f -= u.nesting)),
                    'text' === u.type &&
                      0 === f &&
                      r.test(u.content) &&
                      (l[n].children = s =
                        c(s, t, i(u.content, u.level, e.Token)));
          };
