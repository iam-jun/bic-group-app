...
!(function (a, e) {
  ...
  const o = function (a, e) {
    const o = (function (a) {
      ...
      let n = a.defs;
      a.enabled.length
        && (n = Object.keys(n).reduce((e, o) => (a.enabled.indexOf(o) >= 0 && (e[o] = n[o]), e), {})),
      (e = Object.keys(a.shortcuts).reduce((e, o) => (n[o]
        ? Array.isArray(a.shortcuts[o])
          ? (a.shortcuts[o].forEach((a) => {
            e[a] = o;
          }),
          e)
          : ((e[a.shortcuts[o]] = o), e)
      ...
      const r = RegExp(o, 'g');
      return {
        defs: n, shortcuts: e, scanRE: _, replaceRE: r,
      };
    ...
    a.core.ruler.push(
      ...
      (function (a, e, n, o, i) {
        ...
        const r = a.utils.lib.ucmicro;
        const t = new RegExp([r.Z.source, r.P.source, r.Cc.source].join('|'));
        function s(a, o, _) {
          let r;
          let s = 0;
          const l = [];
          return (
            a.replace(i, (o, i, c) => {
              ...
              if (n.hasOwnProperty(o)) {
                ...
                if (i + o.length < c.length && !t.test(c[i + o.length])) return;
              } else m = o.slice(1, -1);
              i > s
          ...
          for (n = 0, i = l.length; n < i; n++) {
            if (l[n].type === 'inline') {
              for (e = (r = l[n].children).length - 1; e >= 0; e--) {
                ((t = r[e]).type !== 'link_open'
                    && t.type !== 'link_close')
                    || (t.info === 'auto' && (c -= t.nesting)),
                t.type === 'text'
                      && c === 0
                      && o.test(t.content)
                      && (l[n].children = r = _(r, e, s(t.content, t.level, a.Token)));
              }
            }
          }
        };
  ...
  return function (n, i) {
    const _ = { defs: a, shortcuts: e, enabled: [] };
    const r = n.utils.assign({}, _, i || {});
    o(n, r);
  };
}));
